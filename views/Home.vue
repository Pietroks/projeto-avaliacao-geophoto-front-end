<template>
  <div class="background">
    <section class="hero">
      <div class="container text-center py-5">
        ...
        <p class="hero-description">
          Geophotography is the art of capturing images of the Earth’s surface
          in order to capture its beauty and share it with others. It can range
          from simple snapshots taken with a smartphone to complex shots taken
          with expensive equipment by professionals who have spent years
    ...
    <section
      class="gallery-section bg-gradient py-5 text-light"
      v-scroll-appear
    >
      <div class="container">
