<template>
  <section class="hero">
    <div class="container text-center py-5">
      ...
      <div class="d-flex flex-wrap align-items-center gap-5 justify-content-center w-100">
        <router-link to="/cadastro" class="cta-btn">
          Inscreva-se
          <font-awesome-icon icon="arrow-right" class="ms-2" />
        </router-link>

        <button class="cta-btn" @click="baixarEditalPDF" :disabled="isDownloading">
  ...
  methods: {
    baixarEditalPDF() {
      ...
      try {
        ...
        console.error(e);
        this.alert("Erro ao fazer o download");
      } finally {
        setTimeout(() => {
