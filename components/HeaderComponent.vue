        ...
        <div class="col-12 containerHeader">
          ...
          <div class="col-md-4 divNav">
            ...
            <router-link
              ...
              >Sobre</router-link
            >
            <router-link to="/concurso" class="buttonCadastro"
            ...
            <router-link
              ...
              :class="[
                'navLink',
                { navLinkActive: selectedLink === '/premiacao' },
              ]"
          ...
          <div class="col-md-4 divLogin">
            ...
            <div
              :class="{
                'd-none d-md-flex': !menuLoginAberto,
                'd-block': menuLoginAberto,
              }"
              class="login-buttons"
            >
              ...
              <template v-else>
                <router-link
                  ...
                  :class="[
                    'navLink',
                    { navLinkActive: selectedLink === '/login' },
                  ]"
                  @click="selectLink('/login')"
                  >Entrar</router-link
                >
                <router-link to="/cadastro" class="buttonCadastro"
